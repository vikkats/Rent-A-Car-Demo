...
export function BookingForm() {
  ...
  if (state.status === "success") {
    return (
      <div className="paper-panel booking-panel grid min-h-[510px] place-items-center rounded-[2rem] border border-[#cfe0e3] bg-white p-7 text-center shadow-[0_30px_80px_rgba(16,55,70,.1)] sm:p-10" role="status" aria-live="polite">
  ...
  return (
    <form onSubmit={handleSubmit} className="paper-panel booking-panel rounded-[2rem] border border-[#cfe0e3] bg-white p-6 shadow-[0_30px_80px_rgba(16,55,70,.1)] sm:p-9" aria-label="Request car availability">
      ...
      <button disabled={state.status === "submitting"} type="submit" className="raised-button mt-6 inline-flex min-h-14 w-full items-center justify-center gap-2 rounded-full bg-[#0d5b70] px-6 text-base font-extrabold text-white transition hover:-translate-y-0.5 hover:bg-[#08485c] disabled:cursor-wait disabled:opacity-70 focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-[#0d5b70]">
